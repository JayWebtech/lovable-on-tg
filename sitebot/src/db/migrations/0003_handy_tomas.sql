CREATE TYPE "public"."build_status" AS ENUM('awaiting_payment', 'queued', 'generating', 'deploying', 'live', 'failed', 'expired');--> statement-breakpoint
CREATE TYPE "public"."payment_status" AS ENUM('pending', 'confirmed', 'expired', 'refunded');--> statement-breakpoint
CREATE TABLE "builds" (
...
--> statement-breakpoint
ALTER TABLE "builds" ADD CONSTRAINT "builds_telegram_id_users_telegram_id_fk" FOREIGN KEY ("telegram_id") REFERENCES "public"."users"("telegram_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
